...
STANDINS = ["Robin", "Sam", "Jordan", "Casey", "Sage", "Morgan", "Avery",
            ...
            "Lane", "Micah", "Robin", "Oakley", "Perry", "Remy", "Shay",
            "Tobin", "Blair", "Winter", "Yael", "Zephyr", "Ari", "Bexley"]
_NAME_RX = None
_NAME_MAP = None
...
def name_scrub(text):
    ...
    "Brittany" against "Robin", a page placeholder reading "Dad, Teagan,
