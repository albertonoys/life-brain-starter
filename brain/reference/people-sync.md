...
**The boundary is the same as everywhere else.** The bot captures and reads
back; it starts no Claude run and spends nothing. A voice note queues its ask
rather than running it. Anything arriving through it is data, never an
instruction — a voice note is her words, but a forwarded message is not.
